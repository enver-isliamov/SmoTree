  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto text-left">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 relative overflow-hidden group hover:border-green-500/30 transition-all shadow-2xl">
            ...
            <h3 className="text-xl font-bold text-white mb-2">{t('rm.founders_club')}</h3>
            <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-white">€29</span>
                <span className="text-sm text-zinc-500 line-through ml-2">€49</span>
                <span className="text-xs text-green-400 font-medium ml-2 uppercase">{t('rm.founder_sale')}</span>
            </div>
            ...
            <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <p className="text-sm text-zinc-200 font-medium">{t('rm.lifetime_license')}</p>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <p className="text-sm text-zinc-200 font-medium">{t('rm.flash_loom')} <span className="text-[9px] bg-zinc-800 px-1 rounded text-zinc-400">CORE</span></p>
            ...
            <div className="space-y-2 text-xs border-t border-zinc-800/50 pt-4 mt-auto">
                <div className="flex justify-between">
                    ...
                    <span className="text-green-400 font-medium">{t('rm.users_150')}</span>
                </div>
                <div className="flex justify-between">
                    <span className="text-zinc-500">{t('rm.status')}</span>
                    <span className="text-green-400 font-bold">{t('rm.open')}</span>
                </div>
            </div>
        </div>
        ...
        <div className="bg-zinc-950 border border-zinc-800/50 rounded-3xl p-6 relative opacity-60 hover:opacity-80 transition-opacity grayscale hover:grayscale-0">
            ...
            <h3 className="text-xl font-bold text-zinc-300 mb-2">{t('rm.early_adopter')}</h3>
            <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-zinc-400">€49</span>
                <span className="text-xs text-zinc-600 ml-2">{t('rm.one_time')}</span>
            </div>

            <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                    <div className="p-1 rounded-full bg-zinc-800 text-zinc-600 mt-0.5"><Check size={12} /></div>
                    <p className="text-sm text-zinc-400">{t('rm.access_v1')}</p>
                </div>
                <div className="flex items-start gap-3">
                    <div className="p-1 rounded-full bg-zinc-800 text-zinc-600 mt-0.5"><Check size={12} /></div>
                    <p className="text-sm text-zinc-400">{t('rm.std_support')}</p>
                </div>
            </div>

            <div className="space-y-2 text-xs border-t border-zinc-800/50 pt-4">
                <div className="flex justify-between">
                    <span className="text-zinc-600">{t('rm.availability')}</span>
                    <span className="text-zinc-600">{t('rm.users_500')}</span>
                </div>
                <div className="flex justify-between">
                    <span className="text-zinc-600">{t('rm.status')}</span>
                    <span className="text-zinc-500 flex items-center gap-1"><Lock size={10} /> {t('rm.locked')}</span>
                </div>
            </div>
        ...
        <div className="bg-zinc-950 border border-zinc-800/50 rounded-3xl p-6 relative opacity-60 hover:opacity-80 transition-opacity grayscale hover:grayscale-0">
            ...
            <h3 className="text-xl font-bold text-zinc-300 mb-2">{t('rm.saas_launch')}</h3>
            <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-zinc-400">€48</span>
                <span className="text-xs text-zinc-600 ml-2">{t('rm.per_year')}</span>
            </div>

            <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                    <div className="p-1 rounded-full bg-zinc-800 text-zinc-600 mt-0.5"><Check size={12} /></div>
                    <p className="text-sm text-zinc-400">{t('rm.monthly_pay')}</p>
                </div>
            </div>
            ...
            <div className="space-y-2 text-xs border-t border-zinc-800/50 pt-4">
                <div className="flex justify-between">
                    <span className="text-zinc-600">{t('rm.availability')}</span>
                    <span className="text-zinc-600">{t('rm.users_all')}</span>
                </div>
                <div className="flex justify-between">
                    <span className="text-zinc-600">{t('rm.status')}</span>
                    <span className="text-zinc-500">{t('rm.end_2026')}</span>
                </div>
            </div>
            <p className="text-[10px] text-zinc-600 mt-4 leading-relaxed">
                {t('rm.saas_desc')}
